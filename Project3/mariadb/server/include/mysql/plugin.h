...
void thd_send_flag_on_low(MYSQL_THD thd); /* multicore latency hiding */
void trx_send_ok_thd_low(MYSQL_THD thd); /* multicoree latency hiding */
void trx_put_connection_on_poll_low(MYSQL_THD thd); /* multicore latency hiding */
int thd_check_is_trx_end_low(MYSQL_THD thd);
