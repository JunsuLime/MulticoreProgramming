 ...
 * 
 * before decl THD
 * connection_t structure and put_connection_on_poll
 */
void put_connection_on_poll(struct connection_t *c);
...
public:
   ...
   */
  void thd_put_connection_on_poll() {
      //printf("thd_put_connection_on_poll\n");
      put_connection_on_poll((connection_t*)this->event_scheduler.data);
  }
