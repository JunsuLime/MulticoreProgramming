...
/* multicore
 * 
 * send_flag on function
 */
extern "C"
void thd_send_flag_on_low(THD *thd)
{
    thd->send_flag = TRUE;
}
...
/* multicore
 *
 * is_trx_end flag on function
 */
extern "C"
int thd_check_is_trx_end_low(THD *thd) 
{
    thd->is_trx_end = TRUE;
}
...
/* multicore
 * 
 * send ok to client function
 */
extern "C"
void trx_send_ok_thd_low(THD *thd)
{
    //printf("trx_send_ok_thd_low is called\n");
...
/* multicore
 *
 * put connection on poll
 */

extern "C"
void trx_put_connection_on_poll_low(THD *thd)
{
    //printf("trx_put_connection_on_poll_low\n");
    thd->thd_put_connection_on_poll();
}
