...
struct log_t{
    ...
    /* multicore
     *
     * priority queue (for send ok to client)
     * key: lsn
     * value: trx_t
     * TODO: mutex for proirity queue is needed
     */
    std::priority_queue<wrap_trx, std::vector<wrap_trx>, std::greater<wrap_trx> > trx_table;
